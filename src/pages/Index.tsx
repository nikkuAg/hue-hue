  ...
  const handleScratchComplete = () => {
    setTimeout(async () => {
      if (currentPlayerId) {
        ...
        const { data } = await supabase.from("players").select("is_winner").eq("id", currentPlayerId).single();
  ...
  return (
    <div className="min-h-screen bg-cream p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-5">
        ...
        <div
          className="absolute bottom-40 left-1/4 text-6xl opacity-20 animate-float"
          style={{
            animationDelay: "2s",
          }}
        >
        ...
        <div
          className="absolute bottom-20 right-1/3 text-4xl opacity-20 animate-float"
          style={{
            animationDelay: "1.5s",
          }}
        >
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <header className="text-center mb-8 md:mb-12">
          ...
          <div className="flex justify-center gap-4">
            <Button
              ...
              variant="outline"
              className="border-coral hover:bg-coral transition-colors text-[#b62d20]"
            >
            ...
            <Card className="p-6 md:p-8 shadow-elegant border-2 border-teal/40 bg-white">
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <h2 className="text-2xl md:text-3xl font-playfair font-semibold mb-2 text-navy">Join Lucky Draw</h2>
                ...
                <div className="space-y-4">
                  <Input
                    ...
                    className="text-lg h-12 border-2 border-teal/40 focus:border-teal bg-white font-sans"
                  />
                  ...
                  {!urlSessionCode && (
                    <Input
                      ...
                      className="text-lg h-12 border-2 border-teal/40 focus:border-teal text-center font-bold tracking-wider bg-white"
                      maxLength={6}
                    />
                  )}
                  <Button
        ...
        {gameState === "waiting" && !loading && (
          <Card className="p-6 md:p-8 shadow-card border-teal/20 bg-gradient-to-br from-cream to-white-smoke animate-fade-in">
            <div className="space-y-6">
              <div className="text-center">
                <Gift className="w-16 h-16 text-coral mx-auto mb-4 animate-float" />
                <h2 className="text-2xl md:text-3xl font-playfair font-semibold mb-2 text-navy">Welcome! 🎊</h2>
                <p className="text-muted-foreground font-sans">Waiting for the host to start the game...</p>
              </div>
              ...
              <div className="bg-white-smoke rounded-lg p-6 md:p-8 text-center">
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div>
                    <div className="text-4xl md:text-5xl font-bold text-navy mb-2">{players.length}</div>
              ...
              <Button
                ...
                variant="outline"
                className="w-full border-coral text-coral hover:bg-coral hover:text-white font-sans"
              >
                Leave Game
              </Button>
            </div>
        ...
        {gameState === "playing" && (
          <div className="space-y-6 animate-fade-in">
            <div className="text-center">
              <h2 className="text-2xl md:text-3xl font-playfair font-semibold mb-2 text-navy">Scratch to Reveal! ✨</h2>
              <p className="text-muted-foreground font-sans">Use your finger or mouse to scratch the card</p>
            </div>
                    ...
                    isWinner ? (
                      <div className="text-center space-y-4 bg-mint-light/30 p-8 rounded-lg h-full flex flex-col items-center justify-center">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-lg md:text-xl text-navy font-semibold">You're a Winner! 🎉</p>
                        </div>
                      </div>
                    ) : (
                      <div className="text-center space-y-4">
                        ...
                        <div className="space-y-2">
                          <h3 className="text-xl md:text-2xl font-semibold text-navy">Thank You for Playing!</h3>
                          <p className="text-sm md:text-base text-muted-foreground">We appreciate your participation</p>
                        </div>
                      </div>
                    )
                  }
            ...
            <div className="text-center space-y-6">
              {isWinner ? (
                <>
                  ...
                  <p className="text-lg md:text-xl text-foreground">You're a Winner! A special gift awaits you!</p>
                </>
              ) : (
                <>
                  <div className="text-6xl md:text-8xl animate-float">🌟</div>
                  <h2 className="text-2xl md:text-3xl font-semibold text-foreground">Thanks for Playing!</h2>
                  <p className="text-base md:text-lg text-muted-foreground">We hope you enjoyed the celebration!</p>
                </>
              )}
            </div>
          </Card>
