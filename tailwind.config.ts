    ...
    extend: {
      ...
      keyframes: {
        ...
        "cloud-float-gentle": {
          ...
          "10%": { opacity: "1" },
          "50%": { transform: "translateY(calc(var(--float-distance, 20px) / -2))" },
          "90%": { opacity: "1" },
          "100%": { transform: "translateY(calc(var(--float-distance, 20px) * -1))", opacity: "0" },
        },
      },
      animation: {
        ...
        "cloud-float-gentle": "cloud-float-gentle 10s ease-in-out forwards",
      },
    },
  },
